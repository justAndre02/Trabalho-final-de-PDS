...
@Component({
  selector: 'app-tattooartist',
  templateUrl: './tattooartist.component.html',
  styleUrls: ['./tattooartist.component.css']
})
export class TattooartistComponent implements OnInit {
id : any
name : any
phone :any
email : any
